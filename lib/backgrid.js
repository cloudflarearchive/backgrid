...
(function (root) {
  ...
  _.extend(DatetimeFormatter.prototype, {
    ...
    toRaw: function(formattedData) {
      ...
      var HHmmssSSS = this.TIME_RE.exec(time) || [];
      var zzZZ = this.ZONE_RE.exec(zone) || [];
      if (this.includeDate && "undefined" === typeof YYYYMMDD[0]) {
        return void 0;
      }
      if (this.includeTime && "undefined" === typeof HHmmssSSS[0]) {
        return void 0;
      }
  ...
  var NumberCell = Backgrid.NumberCell = Cell.extend({
    ...
    initialize: function(options) {
      ...
      if (options) {
        this.decimals = "undefined" !== typeof options.decimals ? options.decimals : this.decimals;
        this.decimalSeparator = "undefined" !== typeof options.decimalSeparator ? options.decimalSeparator : this.decimalSeparator;
        this.orderSeparator = "undefined" !== typeof options.orderSeparator ? options.orderSeparator : this.orderSeparator;
      }
  ...
  var DatetimeCell = Backgrid.DatetimeCell = Cell.extend({
    ...
    initialize: function(options) {
      Cell.prototype.initialize.apply(this, arguments);
      if (options) {
        this.includeDate = "undefined" !== typeof options.includeDate ? options.includeDate : this.includeDate;
        this.includeTime = "undefined" !== typeof options.includeTime ? options.includeTime : this.includeTime;
      }
  ...
  var Body = Backgrid.Body = Backbone.View.extend({
    ...
    insertRow: function(model, collection, options) {
      ...
      if (options) {
        ...
        if ("undefined" === typeof options.render || options.render) {
