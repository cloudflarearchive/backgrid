...
(function (_, Backbone, Backgrid, lunr) {
  ...
  */
  var ServerSideFilter = Backgrid.Extension.ServerSideFilter = Backgrid.View.extend({
    ...
    */
    render: function () {
      this.empty().el.innerHTML = this.template({
        name: this.name,
  ...
  */
  var ClientSideFilter = Backgrid.Extension.ClientSideFilter = ServerSideFilter.extend({
    ...
    */
    search: function () {
      var matcher = _.bind(this.makeMatcher(this.searchBox().value), this);
  ...
  */
  Backgrid.Extension.LunrFilter = ClientSideFilter.extend({
    ...
    */
    search: function () {
      var searchResults = this.index.search(this.searchBox().value);
      var models = [];
